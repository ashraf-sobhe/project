...
export default function ContactSection() {
  return (
    <section
      id="contact"
      className="w-full bg-gradient-to-b from-gray-50 to-white py-20 px-6 md:px-12 lg:px-20"
    >
  ...
  {[
    ...
    <div
      key={index}
      className="flex flex-row-reverse items-center gap-4 p-4 bg-white rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300"
    >
      {/* الأيقونة بدائرة */}
